...
class Viewer {
  ...
  refreshPastePreview() {
    ...
    const { width, height, region } = this.activePaste;
    const image = this.currentImage;
  ...
  commitActivePaste() {
    ...
    const { position, region, width, height } = this.activePaste;
    const image = this.currentImage;
    ...
    image.dirty = true;
    this.saveManager.markDirty(image);
    console.log('[Viewer] paste committed', { position: { startX, startY }, width, height });
    this.activePaste = null;
    this.pasteRect.style.display = 'none';
    this.render();
  }
  ...
  pasteClipboard(targetCoords) {
    ...
    console.log('[Viewer] paste initiated', { position: this.activePaste.position, width: this.activePaste.width, height: this.activePaste.height });
